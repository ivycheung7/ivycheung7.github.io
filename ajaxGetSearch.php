...
$sql = "SELECT pet_name, dob, picturePath, pet_description, shelter_name FROM petInfo join shelterInfo using (shelterId) where petType='$petType' and breed='$breed' and furColor='$furColor'";
